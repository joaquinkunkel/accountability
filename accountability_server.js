...
var https = require('https'); //this is needed to create an https server

const ssl_options = {
    cert: fs.readFileSync('ssl/fullchain.pem'), //make sure the paths exist
...
app.use(express.static('public/accountability/public'));
...
////// START A SERVER
///////////////////////////////////////////////////////////
// that's how we create a https server - make sure the https node module is loaded
