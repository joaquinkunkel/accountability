...
function showForm(){
	...
	$("#dontsee").click(function(){
		...
		$(this).html("You can submit about public spaces on campus close to your current location.<br/>If you believe we've ommitted a place, please submit a <a href='https://docs.google.com/forms/d/e/1FAIpQLSewEI4cNMiTnzc-MjdARza71soV97PNKUMXcjs9NIPjm11pMA/viewform?usp=sf_link'>request form</a>.")
	});
